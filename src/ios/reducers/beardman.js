...
export const CHECK_INTERVAL = 500; //for tests every 1 sec
			...
			return state
				...
				.update(state => {
					...
					if(angry < 0 && numberOfWarnings === 0) {
						...
						// 	const texts = beardManVocabulary.get('notify');
						// 	PushNotification.localNotification({
						// 		/* Android Only Properties */
						// 		id: 0, // (optional) default: Autogenerated Unique ID
						// 		title: "PlushyBeard", // (optional)
						//
						// 		/* iOS and Android properties */
						// 		message: texts.get(Math.floor(Math.random() * texts.size))
						// 	});
						// }
						const texts = beardManVocabulary.get('notify');
						PushNotification.localNotification({
